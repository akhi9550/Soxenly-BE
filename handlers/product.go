...
func ShowAllProducts(c *gin.Context) {
	...
	products, err := usecase.ShowAllProducts(page, count, category, minPrice, maxPrice)
	if err != nil {
...
func UpdateProduct(c *gin.Context) {
	...
	a, err := usecase.UpdateProduct(p)
	if err != nil {
		errorRes := response.ClientResponse(http.StatusBadRequest, "Could not update the product", nil, err.Error())
		c.JSON(http.StatusBadRequest, errorRes)
		return
	}

	successRes := response.ClientResponse(http.StatusOK, "Successfully updated the product", a, nil)
	c.JSON(http.StatusOK, successRes)
...
func GetProductDetails(c *gin.Context) {
	...
	if err != nil {
		errorRes := response.ClientResponse(http.StatusBadRequest, "product id not in right format", nil, err.Error())
		c.JSON(http.StatusBadRequest, errorRes)
		return
	}
...
func GetNewArrivals(c *gin.Context) {
	...
	success := response.ClientResponse(http.StatusOK, "Successfully retrieved new arrivals", products, nil)
	c.JSON(http.StatusOK, success)
}
