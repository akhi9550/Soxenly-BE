...
func AddToCart(c *gin.Context) {
	...
	cartResponse, err := usecase.AddToCart(product_id, user_ID.(int), size, qty)
	if err != nil {
...
func RemoveFromCart(c *gin.Context) {
	...
	size := c.Query("size")
	updatedCart, err := usecase.RemoveFromCart(product_id, userID.(int), size)
	if err != nil {
...
func UpdateQuantityAdd(c *gin.Context) {
	...
	size := c.Query("size")
	if err := usecase.UpdateQuantityAdd(id.(int), productID, size); err != nil {
...
func UpdateQuantityless(c *gin.Context) {
	...
	size := c.Query("size")
	if err := usecase.UpdateQuantityless(id.(int), productID, size); err != nil {
